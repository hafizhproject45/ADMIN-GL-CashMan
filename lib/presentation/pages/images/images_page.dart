          ...
          child: BlocBuilder<GetAllPaymentCubit, GetAllPaymentState>(
            builder: (context, state) {
              if (state is GetAllPaymentLoaded) {
                ...
                int totalBytes = payments
                    .map((payment) => payment.imageSize ?? 0)
                    .reduce((a, b) => a + b);
                ...
                return Column(
                  children: [
                    ...
                    Text(
                      'Total Image: ${payments.length}',
                      style: AppTextStyle.mediumThin,
                    ),
                    const SizedBox(height: 5),
                    Text(
                      'Total Image Size: ${Utility.convertBytesToGigabytes(totalBytes).toStringAsFixed(2)} GB of 5 GB',
                      style: AppTextStyle.mediumThin,
                    ),
                    GridView.builder(
